...
// $ java ArrayEx3 | abcd | 가나다 | 123 | 12345 / args의 0번째 방에 abcd가 있다. / [0]의 0번째 방에는 a가 있다 => 2차원 배열 / 배열 : 연속된 기억공간
public class ArrayEx3 {
	...
	public static void main(String[] args) { // args / 배열 매개변수 / ping | 168.126.63.1 | -t
		...
		// ----------- 향상된 for문으로 출력해 보세요.
		for(String st : args) { // class로 객체가 선언 / 객체 클래스 선언 방식 => int[] num = new int[5] 
